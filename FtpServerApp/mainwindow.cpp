...
void MainWindow::loadSettings()
{
    ...
    ui->lineEditUserName->setText(settings.value("settings/username", "root").toString());
    ui->lineEditPassword->setText(settings.value("settings/password", "root").toString());
    ui->lineEditRootPath->setText(settings.value("settings/rootpath", QStandardPaths::writableLocation(QStandardPaths::MoviesLocation)).toString());
...
void MainWindow::startServer()
{
    ...
    delete server;
    server = new FtpServer(this, ui->lineEditRootPath->text(), "", ui->lineEditPort->text().toInt(),
        userName, password, ui->checkBoxReadOnly->isChecked(), ui->checkBoxOnlyOneIpAllowed->isChecked());
